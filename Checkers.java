...
/**
 * [Checkers.java]
 * A class that encapsulates a virtual checkers game by handling game components
 * such as a network, settings, player, board, timers, profiles, and a
 * visualizer.
 * 
 * @author Nabeth Ghazi
 * @author Edwin Sun
...
public class Checkers {
    ...
    public Checkers() {
        try {
            this.playerSettings = new Settings(Resources.PLAYER_SETTINGS);
            this.setGameParams(this.playerSettings);
            this.AIPlayer = new AI(this.playerSettings.getAIDifficulty());
            this.playerProfile = new Profile(Resources.PLAYER_PROFILE);
