...
/**
 * The {@code GameRunner} class maintains the flow of a checkers game based on
 * the player turn.
 */
            ...
            public void run() {
                try {
                    ...
                    if (GameRunner.this.game.isPvP()) {
                        ...
                        GameRunner.this.game.getPlayerProfile().writeToTxt(Resources.PATH + Resources.PLAYER_PROFILE);
                    }
