...
/**
 * The {@code SettingsFrame} class displays a frame on the screen containing the
 * settings editor, allowing the user to modify all settings parameters.
 */
        ...
        public void actionPerformed(ActionEvent ev) {
            if (ev.getSource() == SettingsFrame.this.cancelButton) {
                ...
                try {
                    ...
                    settings.writeToTxt(Resources.PATH + Resources.PLAYER_SETTINGS);
